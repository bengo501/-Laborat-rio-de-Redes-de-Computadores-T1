#  bibliotecas necessárias para sistema, tempo, sistema operacional e dispositivo
import sys
import time
import os
...
class Interface:
    # inicializa interface com dispositivo e flag de execução
    ...
    # mostra menu principal com opções disponíveis
